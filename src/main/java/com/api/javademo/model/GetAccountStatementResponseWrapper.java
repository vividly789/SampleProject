...
public class GetAccountStatementResponseWrapper {

	 private List<Statement> response;
	...
	return map;
	 ...
	 public List<Statement> getResponse(){
		 return response;
	} 
	 public void setResponse(List<Statement> response){
