package com.api.javademo.logging;
...
public class LoggingAspect {
	...
	@Pointcut("execution(* com.api.javademo.controller.*.*(..)) || execution(* com.api.javademo.services.*.*(..)) || execution(* com.api.javademo.dao.*.*(..))")
	private void selectAll() {
	}

	@AfterReturning(pointcut = "execution(* com.api.javademo.controller.*.*(..))", returning = "retVal")
	...
	@Pointcut("execution(* com.api.javademo.controller.*.*(..))")
